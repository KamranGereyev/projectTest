...
function* workerGetTasks() {
  try {
    ...
    const currentURL = `https://uxcandy.com/~shapoval/test-task-backend/v2/?developer=softlex-kamran&sort_field=${currentSortField}&page=${currentPage}&sort_direction=${isCurrentSortDirectionDesc ? 'desc': 'asc'}`;
